...
<template>
  ...
  <el-aside
    v-if="subMenuItems.length > 0 && !collSubMenu" :width="`${menuSetting.subMenu.width}px`"
    class="z-2 h-100vh of-x-hidden!" style="border-right:1px solid var(--el-border-color);"
  >
    <el-container class="h-full">
      ...
      <el-main class="p0!">
        <!-- Sub-menu 副栏菜单 -->
        <el-menu class="sub-menu b-r-none!" unique-opened>
          <template #default>
